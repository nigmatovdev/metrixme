// Proxy for the signup-request form. Forwards to the metrixme backend server-side
...
//   SIGNUP_UPSTREAM_URL  full backend endpoint, e.g. https://metrixme.com/api/signup-requests
